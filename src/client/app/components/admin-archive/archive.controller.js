(function () {
  ...
  function ArchiveController($q, $http, $state, $stateParams, $scope, $rootScope, $uibModal, authService) {
    ...
    vm.detailArchive = function (arId) {
      vm.animationsEnabled = true;
      $rootScope.id = arId;
      var modalInstance = $uibModal.open({
        animation: vm.animationsEnabled,
  ...
  angular.module('app.adminarchive')
    .controller('detailArchive', ['$q', '$http', '$state', '$stateParams', '$scope', '$rootScope', '$uibModalInstance', detailArchive]);

  function detailArchive($q, $http, $state, $stateParams, $scope, $rootScope, $uibModalInstance) {
    var vm = this;
